...
export default function RejectedCampaigns() {
  ...
  return (
    <div className="fade-in admin-table-wrapper">
      <div className="table-header-bar">
        <h4>Campagnes rejetées ({rejectedCampaigns.length})</h4>
      </div>
          ...
          <tbody>
            {rejectedCampaigns.map(camp => (
              <tr key={camp.id}>
                ...
                <td><span className="status-badge refuse">Refusée</span></td>
