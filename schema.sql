...
CREATE TABLE IF NOT EXISTS public.admin_logs (
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    admin_user_id uuid REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL,
    action_type character varying(100) NOT NULL,
    entity_type character varying(100) NOT NULL,
    entity_id character varying(100),
    target_user_id uuid REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE SET NULL,
    target_campaign_id uuid REFERENCES public.campaigns(id) ON UPDATE CASCADE ON DELETE SET NULL,
    description text NOT NULL,
